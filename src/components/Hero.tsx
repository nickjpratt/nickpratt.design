...
export function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative mx-auto flex min-h-[calc(100dvh-4rem)] max-w-[1240px] flex-col justify-center overflow-hidden px-6 py-16 md:px-10"
    >
      {/* Midnight glow (dark only) */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10 light:opacity-0"
        style={{
          background:
